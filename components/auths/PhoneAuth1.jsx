...
export default function PhoneAuth1({ navigation, route }) {
    ...
    const suite = async (countryPhone) => {
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "white", }}>
            ...
            />
                ...
                <View style={{ alignSelf: "center", flexDirection: "column", justifyContent: "flex-start", backgroundColor: "white", height: "95%", position: "absolute", top: "5%", width: WIDTH * 0.8, paddingLeft: 13, paddingTop: 10 }}>
                    ...
                    <TouchableOpacity onPress={() => phoneNumber.length > 5 ? suite(countryCode+phoneNumber) : null} style={{ height: 50, width: "70%", backgroundColor: phoneNumber.length > 5 ? '#F63A6E' : "lightgray", alignSelf: "center", marginTop: 70, alignContent: "center", alignItems: "center", borderRadius: 25 }}>
